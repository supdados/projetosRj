...
<section aria-labelledby="editar-usuario-title" class="flex flex-col gap-6">
	<header class="flex flex-col gap-2">
		...
		<h1 id="editar-usuario-title" class="font-heading text-2xl font-bold text-text-primary">
