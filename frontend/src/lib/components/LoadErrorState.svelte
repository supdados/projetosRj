<script lang="ts">
	 ...
	 *
	 * As telas com erro multi-branch (not_found/forbidden com links próprios,
	 * ex.: detalhe do projeto e histórico) NÃO usam este componente.
	 *
	 * Uso:
	...
	let { message, onRetry, retryLabel = 'Tentar novamente' }: Props = $props();
</script>
