					...
					<div class="border-t border-border-subtle">
						...
						{:else if addOpen}
							...
							<form
								...
								class="bg-surface {addDraft.saving ? 'pointer-events-none opacity-[0.72]' : ''}"
							...
							>
								...
								>
									<textarea
										...
										class="max-h-[120px] min-h-[32px] w-full min-w-0 resize-y rounded-md border border-border-subtle bg-surface px-2 py-1.5 text-sm leading-normal text-text-primary transition-colors duration-fast focus:border-brand focus:outline-none disabled:opacity-60"
									></textarea>
									<SelectMenu
