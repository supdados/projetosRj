<script lang="ts">
	/**
	 * Skeleton de Admin > Usuários > Editar, espelho do estado pronto
	 * (UserForm.svelte): 3 fieldsets em card (Identificação, Credenciais,
	 * Vínculo e Permissões) + barra de ações. Sem salto de layout na 1a visita.
	 */
