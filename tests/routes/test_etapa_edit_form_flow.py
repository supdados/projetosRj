...
def test_edit_etapa_form_post_updates_fields_normalizes_done_and_logs_history(app, client_user, seed_data):
    ...
    with app.app_context():
        ...
        history = (
            ...
            .filter_by(project_id=seed_data['project_id'], action_type='edit_etapa')
