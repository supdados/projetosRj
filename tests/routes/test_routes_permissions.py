...
AREA_PROTECTED_CASES = [
    ...
    {
        "id": "outsider_api_etapas_reorder",
        "method": "POST",
    ...
    {
        "id": "outsider_api_etapa_toggle_iniciada",
        "method": "POST",
        "path": "/api/etapas/{etapa_id}/toggle-iniciada",
        "expected_status": 404,
    },
    {
        "id": "outsider_api_etapa_update_field",
        "method": "POST",
    ...
    {
        "id": "outsider_api_project_cascade",
        "method": "POST",
    ...
    {
        # /api/tarefas/<id>/campos concentra descricao/prioridade/tipo_pedido —
        # as tres rotas Jinja separadas viraram um endpoint so.
        "id": "outsider_api_task_campos",
        "method": "POST",
        "path": "/api/tarefas/{task_id}/campos",
        "json": {"descricao": "Bloqueado", "prioridade": "alta"},
        "expected_status": 404,
    },
    {
        "id": "outsider_api_task_status",
        "method": "POST",
    ...
    {
        "id": "outsider_api_task_criar",
        "method": "POST",
        "path": "/api/tarefas",
        "json": {"project_id": "{project_id}", "descricao": "Item bloqueado"},
        "expected_status": 404,
    },
    {
        "id": "outsider_api_task_suggestions",
        "method": "GET",
    ...
    {
        "id": "outsider_api_task_hub_suggestions",
        "method": "GET",
    ...
    {
        "id": "outsider_api_task_finalize",
        "method": "POST",
        "path": "/api/tarefas/{task_id}/finalizar",
        "expected_status": 404,
    },
    {
        "id": "outsider_api_task_reativar",
        "method": "POST",
        "path": "/api/tarefas/{task_id}/reativar",
        "expected_status": 404,
    },
    {
        "id": "outsider_api_task_desarquivar",
        "method": "POST",
...
LEITOR_FORBIDDEN_CASES = [
    # Rotas ajax de etapa cortadas no item 2.2: o par 404/403 passou para /api/*.
    {
        "id": "leitor_api_etapas_reorder",
        "method": "POST",
        "path": "/api/projetos/{project_id}/etapas/reordenar",
        "json": {"etapa_ids": ["{etapa_id}"]},
    },
    {
        "id": "leitor_api_etapa_toggle_iniciada",
        "method": "POST",
        "path": "/api/etapas/{etapa_id}/toggle-iniciada",
    },
    {
        "id": "leitor_api_etapa_update_field",
        "method": "POST",
        "path": "/api/etapas/{etapa_id}/update-field",
        "json": {"field": "descricao", "value": "Bloqueado"},
    },
    {
        "id": "leitor_api_project_cascade",
        "method": "POST",
        "path": "/api/projetos/{project_id}/cascade",
        "json": {"etapa_id": "{etapa_id}", "days_diff": 1},
    },
    {
        # /api/tarefas/<id>/campos concentra descricao/prioridade/tipo_pedido —
        # as tres rotas Jinja separadas viraram um endpoint so.
        "id": "leitor_api_task_campos",
        "method": "POST",
        "path": "/api/tarefas/{task_id}/campos",
        "json": {"descricao": "Bloqueado", "prioridade": "alta"},
    },
    {
        "id": "leitor_api_task_status",
        "method": "POST",
        "path": "/api/tarefas/{task_id}/status",
        "json": {"status": "em_andamento"},
    },
    {
        "id": "leitor_api_task_criar",
        "method": "POST",
        "path": "/api/tarefas",
        "json": {"project_id": "{project_id}", "descricao": "Item bloqueado"},
    },
    ...
    {
        "id": "leitor_api_task_desarquivar",
        "method": "POST",
        "path": "/api/tarefas/{task_id}/desarquivar",
    },
]
