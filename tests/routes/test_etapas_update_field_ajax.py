...
def test_update_etapa_data_inicio_uses_business_days_and_shifts_end_date(app, client_user, seed_data):
    response = client_user.post(
        f"/etapa/{seed_data['etapa_started_id']}/update_field",
...
def test_update_etapa_data_fim_weekend_is_normalized_to_next_business_day(app, client_user, seed_data):
    response = client_user.post(
        f"/etapa/{seed_data['etapa_started_id']}/update_field",
