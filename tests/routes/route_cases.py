ROUTE_CASES = [
    ...
    {
        'id': 'caderno_blocks_post',
        'method': 'POST',
        'rule': '/api/caderno/blocks',
        'path': '/api/caderno/blocks',
        'role': 'user',
        'json': {'block_type': 'text', 'content': 'Smoke caderno'},
        'expected_status': 201,
        'requires_login': True,
        'requires_admin': False,
    },
    {
        'id': 'caderno_blocks_reorder_post',
        'method': 'POST',
        'rule': '/api/caderno/blocks/reorder',
        'path': '/api/caderno/blocks/reorder',
        'role': 'user',
        'json': {'items': []},
        'expected_status': 400,
        'requires_login': True,
    ...
    {
        'id': 'caderno_state_patch',
        'method': 'PATCH',
        'rule': '/api/caderno/state',
        'path': '/api/caderno/state',
        'role': 'user',
        'json': {'expand_steps': 1},
        'expected_status': 200,
        'requires_login': True,
    ...
    {
        'id': 'caderno_block_patch_missing',
        'method': 'PATCH',
        'rule': '/api/caderno/blocks/<int:block_id>',
        'path': '/api/caderno/blocks/999999',
        'role': 'user',
        'json': {'content': 'Sem bloco'},
        'expected_status': 404,
        'requires_login': True,
        'requires_admin': False,
    },
    {
        'id': 'caderno_block_delete_missing',
        'method': 'DELETE',
        'rule': '/api/caderno/blocks/<int:block_id>',
        'path': '/api/caderno/blocks/999999',
        'role': 'user',
