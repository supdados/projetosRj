def test_admin_templates_list_has_clickable_rows_and_only_duplicate_delete(client_admin):
...
def test_admin_templates_list_has_search_and_sort(client_admin):
    ...
    for opt in ('mais_usados', 'nome', 'mais_etapas', 'maior_duracao', 'edicao_recente'):
