...
def test_delete_task_item_ajax_forbidden_for_non_author_collaborator_and_audited(app, client_editable, seed_data):
    item_id = seed_data['task_item_id']

    response = client_editable.post(f'/tarefas/itens/{item_id}/delete', headers=AJAX_HEADERS)
    ...
    with app.app_context():
        ...
        audit = (
            ...
            .filter_by(task_id=item_id, action_type='forbidden_delete')
