...
guard (rebaixar o último admin falha com 422) continua correto.
"""
...
def test_rebaixar_ultimo_admin_retorna_422(app, client_admin, seed_data):
    """Rebaixar (PUT) o único admin ativo continua bloqueado com 422."""
    ...
    assert "administrador" in payload["error"]["message"].lower()
