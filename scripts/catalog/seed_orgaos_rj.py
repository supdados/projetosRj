...
HIERARQUIA = [
    ...
    ('PRODERJ', 'Centro de Tecnologia de Informação e Comunicação', 'Autarquia', 'SETD', 3),
    ...
    ('SUBINFR', 'Subsecretaria de Infraestrutura Escolar', 'Subsecretaria', 'SEEDUC', 1),
        ...
        try:
            for sigla, nome, tipo, pai_sigla, ordem in HIERARQUIA:
                ...
                if pai_sigla and pai_id is None:
                    pai_existente = OrgaoUnidade.query.filter_by(sigla=pai_sigla).first()
