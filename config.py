...
def build_app_config(*, is_testing=False, is_debug=False):
    return dict(
        ...
        SESSION_COOKIE_SECURE=_env_flag_is_true(
        ...
        GOVBR_OIDC_FEDERATED_LOGOUT_ENABLED=_env_flag_is_true(
            "GOVBR_OIDC_FEDERATED_LOGOUT_ENABLED", default="true"
        ),
        ...
        GOOGLE_CALENDAR_ENABLED=_env_flag_is_true(
            "GOOGLE_CALENDAR_ENABLED", default="true"
        ),
        GOOGLE_CALENDAR_CLIENT_SECRET_FILE=os.getenv(
            "GOOGLE_CALENDAR_CLIENT_SECRET_FILE", "config/client_secret.json"
        ),
        GOOGLE_CALENDAR_PUBLIC_BASE_URL=os.getenv(
            "GOOGLE_CALENDAR_PUBLIC_BASE_URL", ""
        ),
        ...
        GOOGLE_CALENDAR_TIMEOUT_SECONDS=_env_int(
            "GOOGLE_CALENDAR_TIMEOUT_SECONDS", default=10
        ),
