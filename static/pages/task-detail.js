    var taskDetailConfig = window.__TASK_DETAIL_CONFIG__ || {};
    ...
    (function () {
        ...
        function updateView(titulo, projectId, projectTitulo) {
            ...
            var projectDetailUrlTemplate = taskDetailConfig.projectDetailUrlTemplate || '/project/0';
            var projectDetailUrl = projectDetailUrlTemplate.replace('/0', '/' + (projectId || ''));
            if (isLink) {
    ...
    var taskItemsKanbanManager = (function () {
        ...
        var storageKey = taskId ? ('task-items-view:' + taskId) : null;
        ...
        function syncToggleColors(mode) {
            ...
            if (toggleVisual.fillLeft) {
                toggleVisual.fillLeft.setAttribute(
                    'fill',
                    isList ? 'url(#taskItemsViewToggleActive)' : 'url(#taskItemsViewToggleInactive)'
                );
            }
            if (toggleVisual.fillRight) {
                toggleVisual.fillRight.setAttribute(
                    'fill',
                    isList ? 'url(#taskItemsViewToggleInactive)' : 'url(#taskItemsViewToggleActive)'
                );
            }
        ...
        function syncListOrderFromKanban() {
            ...
            var addRow = listEl.querySelector('#addItemRow');
            ...
            composers.forEach(function (composer) {
                ...
                function submitComposer(event) {
                    ...
                    window.taskItemsListBridge.requestAddItem({
                        ...
                        .then(function (data) {
                            window.taskItemsListBridge.insertItemFromPayload(data);
                            closeComposer(true);
                            if (currentView === 'kanban') renderKanbanFromList();
                        })
                        .catch(function (error) {
