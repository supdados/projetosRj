        ...
        document.addEventListener('DOMContentLoaded', function() {
            ...
            // ── Sistema de flash unificado ────────────────────────────────
            const FLASH_TIMEOUTS = { success: 2200, info: 2200, warning: 3200, danger: 4200, error: 4200 };
            const FLASH_ICONS = {
            ...
            document.querySelectorAll('.app-flash-stack .app-flash-alert').forEach(function(el) {
                const t = el.dataset.flashType || 'info';
                window.setTimeout(function() { dismissFlash(el); }, FLASH_TIMEOUTS[t] || 2200);
            });
            // ─────────────────────────────────────────────────────────────
