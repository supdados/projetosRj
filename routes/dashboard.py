...
def build_dashboard_context(selected_orgao_id: Optional[int]) -> dict[str, Any]:
    ...
    open_tasks_count_query = apply_task_visibility_rules(
        open_tasks_count_query, include_archived=False
    )
    ...
    task_items_total = (
        task_items_nao_iniciada
        + task_items_em_andamento
        + task_items_para_validacao
        + task_items_para_ajustes
        + task_items_finalizada
    )
